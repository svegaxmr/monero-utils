...
class MainAddressTest {
    ...
    fun genSubaddress() {
        ...
        //println(BinHexUtils.binaryToHex(Keccak.addressChecksum(Base58.decode("87VmKXcMdWqHCyvDoAZSwDEATFUW2Y5443A7GseCna6EiT52tctN9xVTWRJeJLkUKfVrZHT31Pfg74ecKZiTvHjVCSSwkPp"))))
        //println(BinHexUtils.binaryToHex(Keccak.addressChecksum(BinHexUtils.hexToBinary("2ABA74EB26859CA5E6E8880CCFF13794C9C7D7D167FAB44AAC9F4DA33D16094A6E044378CE5FBB144F0DE13C6A923D4DFDEF8B71C43E6C8F0FE6840026BD94467B"))))
